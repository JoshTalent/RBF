    ...
    <>
      ...
      <section id="product" className={layout.sectionReverse}>
        <div className={layout.sectionInfo}>
          ...
          <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
               Recognition
          Rwanda boxing is no linger a hidden secret but a rapidly rising
            force on the continent. Our athletes are consistently delivering
            impressive performance at major african championships and
